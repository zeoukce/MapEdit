...
namespace HoneyFramework
{
    ...
    public class Hex : ISerializable
    {
		...
		static public float hexTexturePotentialReach = 2;//hexTextureScale * hexRadius * Mathf.Sqrt(2) + 0.001f; //~ 2.262 with default honey settings
        ...
        private static void InitializeDirections()
        {
			...
			if (HEX2D) {
				hexTextureScale = 1.8f * hexRadius;
			}
        }
